<div class="row mLR-pe-0">
 <div class="col-xs-12 col-sm-12 col-md-12 pL-pe-0 pR-pe-0">
    ...
    <div class="form-group form-group-pe">
       ...
       <input name="customers[customer_firstname]" id="customer_firstname" value="" class="my-input" tabindex="1" required="" type="text">
       <span class="highlight"></span>
       <span class="bar"></span>
       <label class="my-label">First Name</label>
       </div>
       <div class="col-xs-6 col-md-6 pull-left pLR-pe-0">
       <input name="customers[customer_lastname]" id="customer_lastname" value="" class="my-input" tabindex="2" required="" type="text">
       <span class="highlight"></span>
       <span class="bar"></span>
    ...
    <div class="form-group form-group-pe">
       <input class="my-input" id="customer_email" name="customers[customer_email]" value="PEtest@mailinator.com" tabindex="3" required="" type="text">
       <span class="highlight"></span>
       <span class="bar"></span>
       <label class="my-label">Email</label>
    </div>
    <div class="form-group form-group-pe">
       <input class="my-input" id="customer_phone" name="customers[customer_phone]" value="" tabindex="4" required="" type="text">
       <span class="highlight"></span>
       <span class="bar"></span>
       <label class="my-label">Phone</label>
    </div>
    <div class="form-group form-group-pe">
       <input name="customers[password]" id="password" value="" class="my-input" tabindex="5" required="" type="password">
       <span class="highlight"></span>
       <span class="bar"></span>
       <label class="my-label">Password</label>
    </div>
    <div class="form-group form-group-pe">
       <input name="customers[confpassword]" id="confpassword" value="" class="my-input" tabindex="6" required="" type="password">
       <span class="highlight"></span>
       <span class="bar"></span>
       <label class="my-label">Confirm Password</label>
    </div>
    <div class="form-group form-group-pe">
       <select name="customers[customer_refer_by]" id="refer_by_id" required="" class="my-input" tabindex="7">
       <option value=""></option>
    ...
    <div class="form-group form-group-pe">
       <input class="my-input" id="customer_website" name="customers[customer_website]" value="" required="" tabindex="8" type="text">
       <span class="highlight"></span>
       <span class="bar"></span>
    ...
    <div class="form-group form-group-pe mT-pe-20-neg">
    ...
    <div class="form-group form-group-pe text-center mT-pe-30"><input class="continue" value="Submit" name="subAddDetail" tabindex="10" type="submit"></div>
